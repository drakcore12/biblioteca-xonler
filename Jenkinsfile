      ...
      steps {
        script {
          ...
          bat '''
            ...
            echo Eliminando contenedor pg-main directamente si existe...
            "C:\\Program Files\\Docker\\Docker\\resources\\bin\\docker.exe" stop pg-main 2>nul
            "C:\\Program Files\\Docker\\Docker\\resources\\bin\\docker.exe" rm -f pg-main 2>nul
