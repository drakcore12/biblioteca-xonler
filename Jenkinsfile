      ...
      steps {
        script {
          ...
          bat '''
            ...
            echo Deteniendo contenedores app y db si estan corriendo...
            "C:\\Program Files\\Docker\\Docker\\resources\\bin\\docker.exe" compose stop app db 2>nul
            echo Eliminando contenedores app y db para recrearlos...
            "C:\\Program Files\\Docker\\Docker\\resources\\bin\\docker.exe" compose rm -f app db
